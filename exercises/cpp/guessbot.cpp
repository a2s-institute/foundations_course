...
void mode1()
{
    ...
    cout<<"The bot will think of a number between 1 and 100 , your have to guess that number"<<endl;
    ...
    if(guess==random_number)
    {
        cout<<"Congradulations you guessed in "<<count<<" tries"<<endl;
    }
    
    else
    {
        cout<<"Sorry you could'nt guess in 20 tries"<<endl;
    }
